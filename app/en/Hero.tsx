        ...
        <div className="text-center space-y-8">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800">
            ...
            <span className="text-sm font-medium text-blue-900 dark:text-blue-100">
              Pilot Project - Seeking Partners
            </span>
          </div>
          ...
          <p className="max-w-3xl mx-auto text-xl sm:text-2xl text-gray-600 dark:text-gray-300 leading-relaxed">
            A personalized health app that uses artificial intelligence
            to optimize your training, nutrition, and wellness based on
            <span className="font-semibold text-gray-900 dark:text-white"> your real medical data</span>.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-8 pt-8">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">years of life</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">AI adjustments</div>
            </div>
          </div>
          ...
          <div className="pt-8 max-w-2xl mx-auto">
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-gray-200 dark:border-gray-700">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">
                The Goal: Increase Your Life Expectancy & Quality of Life
              </h2>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                Combine your medical data (glucose, cholesterol, blood tests),
                Apple Watch metrics, and your personal goals to create a
                training and nutrition plan that evolves with you day by day.
              </p>
            </div>
          </div>
